...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form role="form" method="POST" action="{{ route('Admin.users.update',$client->id) }}">
                {{ csrf_field() }}
                {{ method_field('put') }}
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Name" name="name" value="{{ $client->name}}">
                        @if ($errors->has('name'))
                      ...
                      <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="exampleInputEmail1" placeholder="Enter phone" name="phone" value="{{ $client->phone}}">
                        @if ($errors->has('phone'))
                        <span class="help-block">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="date" class="form-control" name="data_of_birth" value="{{ $client->data_of_birth}}">
                    </div>
                    <!-- /.input group -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="date" class="form-control reservation" name="last_donation_date" value="{{ $client->last_donation_date}}">
                    </div>
                    <!-- /.input group -->
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;"  tabindex="-1" aria-hidden="true" name="blood_type_id" value="{{ old('blood_type_id') }}">
                      ...
                      <option value="{{ $blood_type->id }}"  {{ $blood_type->id == $client->blood_type_id ? "Selected":""  }}>{{ $blood_type->name }}</option>
                      @endforeach
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;"  tabindex="-1" aria-hidden="true" name="city_id" value="{{ old('city_id') }}">
                        ...
                        <option value="{{ $city->id }}"  {{ $city->id == $client->city_id ? "Selected":""  }}  >{{  $city->governorate->name }} -- {{  $city->name }}</option>
                        @endforeach
        ...
        @if ( $client->hasRole('super_admin')  || $client->hasRole('admin')  )
                  <div class="form-group">
                    <label>Roles</label>
                    <div class="checkbox">
                        <input type="checkbox" name="roles[]" {{ $client->hasRole('super_admin') ? 'checked':'' }}
                        value='2'

                        > Super Admin
                    </div>
                    <div class="checkbox">
                        <input type="checkbox" name="roles[]" {{ $client->hasRole('admin') ? 'checked':'' }}
                        value='3'
                        > Admin
                    </div>
                          ...
                          <div class="tab-content">
                            ...
                            <div class="tab-pane {{ $items == 0 ? 'active' : '' }}" id="{{ $model }}">
                                ...
                                <div class="form-check">
                                    ...
                                    {{ $client->hasPermission($map . '_'. $model) ? 'checked':'' }}
